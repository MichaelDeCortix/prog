...
cal_t=$((time bin/omp8 data/mat_100x100.txt data/mat_100x100b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with omp           $cal_t"
...
cal_t=$((time mpirun -np 8 bin/mpi data/mat_100x100.txt data/mat_100x100b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with mpi           $cal_t"
echo
...
cal_t=$((time bin/omp8 data/mat_1000x1000.txt data/mat_1000x1000b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with omp           $cal_t"

cal_t=$((time bin/thread8 data/mat_1000x1000.txt data/mat_1000x1000b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with Phtreads      $cal_t"

cal_t=$((time mpirun -np 8 bin/mpi data/mat_1000x1000.txt data/mat_1000x1000b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with mpi           $cal_t"
echo
...
cal_t=$((time bin/omp8 data/mat_2000x2000a.txt data/mat_2000x2000b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with omp           $cal_t"

cal_t=$((time bin/thread8 data/mat_2000x2000a.txt data/mat_2000x2000b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with Phtreads      $cal_t"

cal_t=$((time mpirun -np 8 bin/mpi data/mat_2000x2000a.txt data/mat_2000x2000b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with mpi           $cal_t"
echo
