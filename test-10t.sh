...
cal_t=$((time bin/omp10 data/mat_100x100.txt data/mat_100x100b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with omp           $cal_t"

cal_t=$((time bin/thread10 data/mat_100x100.txt data/mat_100x100b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
...
cal_t=$((time bin/omp10 data/mat_1000x1000.txt data/mat_1000x1000b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with omp           $cal_t"

cal_t=$((time bin/thread10 data/mat_1000x1000.txt data/mat_1000x1000b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with Phtreads      $cal_t"
...
cal_t=$((time bin/omp10 data/mat_2000x2000a.txt data/mat_2000x2000b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with omp           $cal_t"

cal_t=$((time bin/thread10 data/mat_2000x2000a.txt data/mat_2000x2000b.txt)  2>&1 > /dev/null | grep real | awk '{print $2}')
echo "with Phtreads      $cal_t"
